      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-4">
          ...
          <div className="flex items-center space-x-4">
            ...
            <Link to="/interview" className="bg-gradient-to-r from-orange-400 to-red-500 text-white px-6 py-2 rounded-full hover:from-orange-500 hover:to-red-600 transition-all font-medium">
              Start Interview
            </Link>
          </div>
        </div>
